...
{
    public class SaveCreditNoteDto : FullAuditedEntityDto<long>
    {
        public SaveCreditNoteDto()
        {
        ...
        public virtual ICollection<RecurringInvoiceDetailDto> creditNoteDto { get; set; }
