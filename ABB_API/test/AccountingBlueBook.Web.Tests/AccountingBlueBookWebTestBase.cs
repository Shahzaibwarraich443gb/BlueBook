...
{
    public abstract class AccountingBlueBookWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static AccountingBlueBookWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(AccountingBlueBookWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<AccountingBlueBookDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<AccountingBlueBookDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<AccountingBlueBookDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<AccountingBlueBookDbContext, Task<T>> func)
        {
            T result;
