import { CreateOrEditGeneralEntityTypeInputDto, CreateOrEditJobTitleInputDto, GeneralEntityTypeServiceProxy, JobTitleServiceProxy } from './../../../shared/service-proxies/service-proxies';
...
export class CreateJoTitleComponent
  extends AppComponentBase
  implements OnInit {
  @Output() onSave = new EventEmitter<any>();

  createOrEditJobTitleInputDto = new CreateOrEditJobTitleInputDto();
    ...
    if (this.data.id) {
      if (this.data.id) {
        this._jobTitleServiceProxy
          ...
          .pipe(finalize(() => { }))
          .subscribe((result) => {
            this.createOrEditJobTitleInputDto = result;
          });
      } else
        this.createOrEditJobTitleInputDto =
          new CreateOrEditLanguageInputDto();
    }
  }

  save() {
    this._jobTitleServiceProxy
      .createOrEdit(this.createOrEditJobTitleInputDto)
      .subscribe((arg) => {
