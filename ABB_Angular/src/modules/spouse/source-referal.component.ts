...
import { CreateSourceReferalComponent } from "./create-source-referal/create-source-referal.component";
...
export class SourceReferalComponent extends AppComponentBase implements OnInit {
  ...
  private showCreateOrEditSourceReferralDialog(id?: number): void {
    const dialogRef = this._dialog.open(CreateSourceReferalComponent, {
      data: { id: id },
    });
