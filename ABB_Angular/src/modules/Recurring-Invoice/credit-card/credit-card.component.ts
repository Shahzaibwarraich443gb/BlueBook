...
import { AppComponentBase } from "@shared/app-component-base";
    ...
    import { SaveReceivedPayment, ReceivedPaymentServiceServiceProxy, ChargeCardDto,CompanyCardDto, RecurringInvoiceServiceProxy, } from '@shared/service-proxies/service-proxies';
...
export class CreditCardComponent extends AppComponentBase implements OnInit {
  CompanycardDto= new CompanyCardDto();
  ...
  save() {
    ...
    this.CompanycardDto.ref_CustomerId= this.customerId;
    this._RecurringInvoiceServiceProxy
      .saveCCInfo(this.CompanycardDto)
      .subscribe((arg) => {
        abp.message.success("Card information successfully saved")
        this.dialogRef.close();
